...
import banner from './boelter_background.jpg';
...
import mapImage from './boelter_map.png'//map image
...
function Boelter() {
  ...
  useEffect(() => {
    async function updateReviewsData() {
      // Get a reference to the database
      const commentsCollection = collection(database, 'locations/boelter/comments'); //CHANGE PATH
      const commentsDoc = await getDocs(commentsCollection)
